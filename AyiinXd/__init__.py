...
if not BLACKLIST_CHAT:
    BLACKLIST_CHAT = [-1001876092598, -1001608701614, -1001812143750, -1001473548283, -1001287188817, -1001861414061, -1001986858575, -1001938430114]
...
ch = str(b64decode("QFF3ZXJ0eVN0b3Jl"))[2:13]
gc = str(b64decode("QEx1bWllcmVzdXBwb3J0"))[2:16]
...
with bot:
    try:
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == lol and query.startswith(
                    "@Lumieresupport"):
                buttons = paginate_help(0, dugmeler, "helpme")
